...
ADD COLUMN minimum_ticket_fee_condition VARCHAR(200) DEFAULT NULL COMMENT '最低票收取条件',
ADD COLUMN document_fee_condition VARCHAR(200) DEFAULT NULL COMMENT '制单费收取条件',
...
ADD COLUMN settlement_cycle VARCHAR(50) DEFAULT NULL COMMENT '结算周期',
