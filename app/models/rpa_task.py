...
class RPATaskType(str, enum.Enum):
    ...
    SHENZHEN_AIR_APPROVAL_DATA = "SHENZHEN_AIR_APPROVAL_DATA"  # 深航订舱-批复数据获取
    SHENZHEN_AIR_APPROVAL_DATA_WIDE_BODY = "SHENZHEN_AIR_APPROVAL_DATA_WIDE_BODY"  # 深航订舱-批复数据获取-宽体
    # 南航任务
    ...
    CHINA_SOUTHERN_AIR_APPROVAL_DATA = "CHINA_SOUTHERN_AIR_APPROVAL_DATA"  # 南航订舱-批复数据获取
    ...
    CHINA_SOUTHERN_AIR_DEPARTURE_TRACKING = "CHINA_SOUTHERN_AIR_DEPARTURE_TRACKING"  # 南航订舱-本站货物+货拉数据获取
    # 制单打印任务
