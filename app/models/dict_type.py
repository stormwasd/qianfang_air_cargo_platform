...
class DictType(Base):
    ...
    type = Column(String(50), unique=True, nullable=False, index=True, comment="唯一类型标识（如：freight_code, goods_code）")
    ...
    def __repr__(self):
        return f"<DictType(id={self.id}, type={self.type}, name={self.name})>"
