...
class CostRegistration(Base):
    ...
    receivable_fuel_fee = Column(Numeric(10, 2), nullable=True, comment="燃油费")
    ...
    pay_intl_air_freight_method = Column(String(50), nullable=True, comment="国际空运-运费计算方式")
    ...
    pay_dom_air_freight_method = Column(String(50), nullable=True, comment="国内空运-运费计算方式")
