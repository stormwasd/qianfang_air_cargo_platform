...
def append_cost_export_headers(ws: Worksheet) -> List[str]:
    ...
    if len(COST_EXPORT_HEADERS) != 115:
        raise RuntimeError("费用登记导出字段数量异常，预期为 115 列")
    ...
    ws.merge_cells(start_row=1, start_column=37, end_row=1, end_column=109)

    for start_col, end_col in ((37, 60), (61, 71), (72, 88), (89, 96), (97, 107)):
        ws.merge_cells(
            start_row=2,
            start_column=start_col,
            end_row=2,
